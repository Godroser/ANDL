-- TPC-H Vector Queries for SeekDB (tpch10_3 schema)
-- tpch10_3: 纯向量查询使用 part_vector / partsupp_vector，其他查询使用非 vector 表 (part, partsupp)
-- Placeholder: {VECTOR} will be replaced with actual vector string
-- Placeholder: {LIMIT} will be replaced with limit value
--
-- Schema 要求: part, partsupp (无向量列), part_vector, partsupp_vector
-- 若 load_table_tpch10_3.sql 未创建 part 表，请先执行 add_part_tpch10_3.sql 补丁
